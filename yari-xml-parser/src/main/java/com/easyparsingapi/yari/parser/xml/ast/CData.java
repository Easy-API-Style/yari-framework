...
public class CData implements AstComment, XmlNode {
    ...
    /**
     * Creates a CData node with the given value and no source location.
     *
     * @param value the raw text content of the CDATA section
     */
    ...
    /**
     * Creates a CData node with the given value and source location.
     *
     * @param value          the raw text content of the CDATA section
     * @param sourceLocation the location of this node in the source document
     */
    @JsonCreator
    public CData(@JsonProperty("value") final String value,
    ...
    /**
     * Returns the raw text content of this CDATA section.
     *
     * @return the CDATA value
     */
    ...
    public boolean equalsNode(final AstNode astNode) {
        ...
        final CData other = (CData) astNode;
    ...
    public boolean equals(final Object object) {
        if (object instanceof CData node) {
