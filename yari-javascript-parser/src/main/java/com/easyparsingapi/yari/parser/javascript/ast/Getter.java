...
/**
 * Represents a JavaScript getter property definition ({@code get name() { ... }}) in the AST.
 * Holds the property name and the getter body ({@link Procedure}).
 */
@JsonPropertyOrder({"name", "procedure", "sourceLocation"})
public class Getter implements JavascriptNode {
    ...
    /**
     * Constructs a {@code Getter} without source-location information.
     *
     * @param name      the property name node
     * @param procedure the getter body
     */
    public Getter(final JavascriptNode name,
                  final Procedure procedure) {
        this(name, procedure, null);
    }

    /**
     * Constructs a {@code Getter} with full source-location information.
     *
     * @param name           the property name node
     * @param procedure      the getter body
     ...
     */
    @JsonCreator
    public Getter(@JsonProperty("name") final JavascriptNode name,
    ...
    public List<AstNode> astChildren() {
        return AstNode.childrenAttributes(name, procedure);
    }
    ...
    /**
     * Sets the parent AST node of this getter.
     *
    ...
    /**
     * Returns the property name node of this getter.
     *
    ...
    /**
     * Returns the body of this getter.
     *
     * @return the {@link Procedure} containing the getter statements
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, procedure, sourceLocation);
    }
    ...
    public String toString() {
        ...
        result.append(Getter.class.getSimpleName());
        result.append(" [name=");
        result.append(name);
     ...
     */
    /**
     * Represents the body of a {@link Getter} as an ordered list of
    ...
    public static class Procedure implements JavascriptProcedure {
         ...
         *
         * @param nodes the list of statements forming the getter body
         */
