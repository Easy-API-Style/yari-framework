...
public class TestReturn {
    ...
    public void test_01(TestInfo testInfo) {
        assertAst(testInfo, "return b===c?b!==0||1/b===1/c:b!==b&&c!==c");
    }

    @Test
    public void test_02(TestInfo testInfo) {
        assertAst(testInfo, "return\"https://apis.google.com\"+za(a,b,c,d)");
    }

    @Test
    public void test_03(TestInfo testInfo) {
        assertAst(testInfo, "return`try{${a}}catch(e){google.dl(e,${0},${JSON.stringify(c)});}`");
    }
