...
public class TestCommaSequence {
    ...
    public void test_07(TestInfo testInfo) {
        final String code = "s=e?f:d, func[pp]";
        assertAst(testInfo, code);
    }

    @Test
    public void test_08(TestInfo testInfo) {
        final String code = "var f=d.getElementsByTagName(s)[0], j=d.createElement(s), dl=l!='dataLayer'?'&l='+l:'';";
        assertAst(testInfo, code);
    }
