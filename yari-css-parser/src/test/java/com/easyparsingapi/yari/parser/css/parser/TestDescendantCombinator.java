...
public class TestDescendantCombinator {
    ...
    public void test_03(TestInfo testInfo) {
        String code =  """
          .nz9sqb .xfBIrd:not(.SKI7Bc) .YoItGe::before {
            background:#062e6f;
            background:var(--gm3-sys-color-on-primary,#062e6f)
          }
        """;
        assertAst(testInfo, code);
    }
    ...
    public void test_04(TestInfo testInfo) {
        String code =  """
          .xfBIrd:not(+ .SKI7Bc.YoItGe::before) {
            background:#062e6f;
            background:var(--gm3-sys-color-on-primary,#062e6f)
          }
        """;
