...
public class OperatorTableExpressionTest extends BaseMockTest {
    ...
    @Mock
    Function<String, String> negate;
    @Mock
    BiFunction<String, String, String> plus;
    @Mock
    BiFunction<String, String, String> subtract;
    @Mock
    BiFunction<String, String, String> multiply;
    @Mock
    Function<String, String> percent;
    @Mock
    BiFunction<String, String, String> point;
    @Mock
    BiFunction<String, String, String> power;
    ...
    private Parser<String> parser() {
        return new OperatorTable<String>().prefix(op("~", toMapOperator(negate)), 100)
                                          .postfix(op("%", toMapOperator(percent)), 80)
                                          .infixr(op("^", toMapInfix(power)), 40)
                                          .infixl(op("+", toMapInfix(plus)), 10)
                                          .infixl(op("-", toMapInfix(subtract)), 10)
                                          .infixl(op("*", toMapInfix(multiply)), 20)
                                          .infixn(op(".", toMapInfix(point)), 200)
    ...
    private static MapOperator<String, String, String> toMapOperator(Function<String, String> fonction) {
        return MapOperator.map(null, fonction);
    }
    
    private static MapInfix<String, String, String, String> toMapInfix(BiFunction<String, String, String> fonction) {
        return MapInfix.map(null, fonction);
    }
