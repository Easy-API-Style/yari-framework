...
import static com.easyparsingapi.yari.parsec.Scanners.WHITESPACES;
...
import com.easyparsingapi.yari.parsec.NumberLiteralsTranslator;
...
public class TerminalsTest {
    ...
    public void testScientificNumberLiteralTokenizer() {
        ...
        assertFailure(mode, Terminals.ScientificNumberLiteral.TOKENIZER, "1e2x", 1, 4, "EOF expected, x encountered.");
    }
    ...
    public void testLongLiteralHexTokenizer() {
        ...
        assertFailure(mode, Terminals.LongLiteral.HEX_TOKENIZER, "0x12x", 1, 5, "EOF expected, x encountered.");
    }
    ...
    public void testCharLiteralParser() {
        assertEquals((Object) 'a', Terminals.CharLiteral.PARSER
                                            .from(Terminals.CharLiteral.SINGLE_QUOTE_TOKENIZER, WHITESPACES).parse("'a'"));
    }
    ...
    public void testStringLiteralParser() {
        assertEquals("abc", Terminals.StringLiteral.PARSER
                                     .from(Terminals.StringLiteral.SINGLE_QUOTE_TOKENIZER, WHITESPACES).parse("'abc'"));
    }
    ...
    public void testPhrase() {
        ...
        Parser<?> parser = terminals.phrase("hello", "world").from(terminals.tokenizer(), Scanners.WHITESPACES);
    ...
    public void testCaseSensitive() {
        ...
        Terminals terminals = Terminals.operators("+", "-")
                                       ...
                                       .build();
        Parser<Token> parser = terminals.token("+", "-", "foo", "bar").from(terminals.tokenizer(), WHITESPACES);
        assertEquals(new Token(0, 1, Tokens.reserved("+")), parser.parse("+"));
        assertEquals(new Token(0, 1, Tokens.reserved("-")), parser.parse("-"));
    ...
    public void testCaseInsensitive() {
        ...
        Terminals terminals = Terminals.operators("+", "-")
                                       .words(Scanners.IDENTIFIER)
                                       .caseInsensitiveKeywords(asList(keywords))
                                       .build();
        Parser<Token> parser = terminals.token("+", "-", "foo", "bar").from(terminals.tokenizer(), WHITESPACES);
        assertEquals(new Token(0, 1, Tokens.reserved("+")), parser.parse("+"));
        assertEquals(new Token(0, 1, Tokens.reserved("-")), parser.parse("-"));
    ...
    public void testCaseSensitive_withScanner() {
        Terminals terminals = Terminals.operators("+", "-").words(Scanners.INTEGER).keywords("12", "34").build();
        Parser<Token> parser = terminals.token("+", "-", "12", "34").from(terminals.tokenizer(), WHITESPACES);
        assertEquals(new Token(0, 1, Tokens.reserved("+")), parser.parse("+"));
        assertEquals(new Token(0, 1, Tokens.reserved("-")), parser.parse("-"));
