...
public class TestManyBetween {
    
    @Test
    public void test_01(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, always(), 
                                                  token("("), token(")"))
                                     .map(Block::new),
                                   "(aa 11 33 cc 22 zz)");
    ...
    public void test_02(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, 
                                                  token("("), token(")"))
                                     .map(Block::new),
                                   "(aa 11 33 cc 22 zz)");
        AssertUtil.assertAstError(testInfo, result);
    ...
    public void test_03(TestInfo testInfo) {
        Result<Ast> result = 
            parse(sequence(id.manyBetween(error, id.peek(), 
                                          token("("), token(")"))
                             .map(Block::new),
                           num.many()
                              .map(Block::new)
    ...
    public void test_04(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, never(), 
                                                  token("("), token(")"))
                                     .map(Block::new),
                                   "(aa 11 cc 22)");
        AssertUtil.assertAstError(testInfo, result);
    ...
    public void test_05(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, token(";"),
                                                  token("("), token(")"))
                                     .map(Block::new),
                                   "(aa 11 ;cc 22)");
        AssertUtil.assertAstError(testInfo, result);
    ...
    public void test_07(TestInfo testInfo) {
        Result<Ast> result = parse(sequence(id.manyBetween(error, always(), 
                                                           token("("), token(")"))
                                              .map(Block::new),
    ...
    public void test_08(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, token("("), token(")"))
                                     .map(Block::new),
                                  "(aa 22");
        AssertUtil.assertAstError(testInfo, result);
    }
    ...
    public void test_10(TestInfo testInfo) {
        try {
            parse(id.manyBetween(error, always(), EOF,
                                 token("("), token(")"))
                    .map(Block::new),
                  "(aa 22");
            ...
            assertEquals("ParserException [location=line 1 column 7, error=EmptyParseError [index=6, encountered=EOF, expected=[], unexpected=EOF]]",
                         e.toString());
        }
    }
    ...
    public void test_11(TestInfo testInfo) {
        try {
            parse(id.manyBetween(error, always(), never(), EOF, token("("), token(")")), "(aa 22");
            fail("Exception Expected!");
        }
        catch (Exception e) {
            assertEquals("ParserException [location=line 1 column 7, error=EmptyParseError [index=6, encountered=EOF, expected=[], unexpected=EOF]]",
    ...
    public void test_12(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, always(), never(), never(), 
                                                  token("("), token(")"))
                                     .map(Block::new),
                                  "(aa 22");
        AssertUtil.assertAstError(testInfo, result);
    ...
    public void test_15(TestInfo testInfo) {
        try {
            parse(id.manyBetween(error, always(), token(";"), 
                                 token("("), token(")")),
                  "(aa vv ; dd)");
            fail("Exception Expected!");
        }
        catch (Exception e) {
            assertEquals("ParserException [location=line 1 column 10, error=EmptyParseError [index=9, encountered=dd, expected=[], unexpected=token[;]]]",
                         e.toString());
        }
    }
    ...
    public void test_18(TestInfo testInfo) {
        Result<Ast> result = parse(id.manyBetween(error, id.peek(),
                                                  token("("), token(")"))
                                     .map(Block::new),
                                   "(aa 11 ;cc)");
        AssertUtil.assertAstError(testInfo, result);
